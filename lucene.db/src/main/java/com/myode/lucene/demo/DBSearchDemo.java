...
import com.myode.lucene.util.JdbcUtil;

@SuppressWarnings({"javadoc","nls"})
public class DBSearchDemo {

	public static final String INDEX_PATH = ".\\db_index";
	public static final String JDBC_URL = "jdbc:mysql://localhost:3306/lucene-demo";
